        ...
        <section className="gradient-hero relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 relative">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <Reveal direction="right" delay={2} className="hidden md:flex justify-center">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
                  {steps.slice(0, 6).map((step: string, i: number) => (
                    <Reveal key={step} delay={i + 1} direction="zoom">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {benefits.map((b: any, i: number) => (
                ...
                <div className="card card-interactive p-8 group cursor-default h-full">
