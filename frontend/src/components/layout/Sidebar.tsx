...
export default function Sidebar({ mobileOpen, onClose }: Props) {
  ...
  const links: NavLink[] = isAdmin
    ? [
        ...
        { to: '/admin/partners', label: t('nav.partners'), icon: '👥', badge: partnersBadge },
        { to: '/admin/pipeline', label: t('nav.pipeline'), icon: '🔀', badge: pipelineBadge },
        { to: '/admin/courses', label: t('nav.courses'), icon: '📚' },
        { to: '/admin/lms-report', label: t('nav.lmsReport'), icon: '🎓' },
        { to: '/admin/conflicts', label: t('nav.conflicts'), icon: '⚔️' },
        { to: '/admin/reports', label: t('nav.reports'), icon: '📈' },
        { to: '/admin/security', label: t('nav.security'), icon: '🔒' },
      ]
    : [
        { to: '/partner', label: t('nav.dashboard'), icon: '📊' },
        { to: '/partner/pipeline', label: t('nav.pipeline'), icon: '🔀' },
        { to: '/partner/courses', label: t('nav.courses'), icon: '📚' },
        { to: '/partner/training', label: t('nav.training'), icon: '🎓' },
        { to: '/partner/conflicts', label: t('nav.conflicts'), icon: '⚔️' },
        { to: '/partner/notifications', label: t('nav.notifications'), icon: '🔔' },
        { to: '/partner/users', label: t('nav.users'), icon: '👥' },
      ];
